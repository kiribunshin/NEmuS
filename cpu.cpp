...
static const Instruction lookup[256] = {
    {"BRK", &CPU::IMM, &CPU::BRK, 7}, {"ORA", &CPU::INX, &CPU::ORA, 6}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"???", &CPU::IMP, &CPU::NOP, 3}, {"ORA", &CPU::ZP0, &CPU::ORA, 3}, {"ASL", &CPU::ZP0, &CPU::ASL, 5}, {"???", &CPU::IMP, &CPU::XXX, 5}, {"PHP", &CPU::IMP, &CPU::PHP, 3}, {"ORA", &CPU::IMM, &CPU::ORA, 2}, {"ASL", &CPU::IMP, &CPU::ASL, 2}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"ORA", &CPU::ABS, &CPU::ORA, 4}, {"ASL", &CPU::ABS, &CPU::ASL, 6}, {"???", &CPU::IMP, &CPU::XXX, 6},
    {"BPL", &CPU::REL, &CPU::BPL, 2}, {"ORA", &CPU::INY, &CPU::ORA, 5}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"ORA", &CPU::ZPX, &CPU::ORA, 4}, {"ASL", &CPU::ZPX, &CPU::ASL, 6}, {"???", &CPU::IMP, &CPU::XXX, 6}, {"CLC", &CPU::IMP, &CPU::CLC, 2}, {"ORA", &CPU::ABY, &CPU::ORA, 4}, {"???", &CPU::IMP, &CPU::NOP, 2}, {"???", &CPU::IMP, &CPU::XXX, 7}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"ORA", &CPU::ABX, &CPU::ORA, 4}, {"ASL", &CPU::ABX, &CPU::ASL, 7}, {"???", &CPU::IMP, &CPU::XXX, 7},
    {"JSR", &CPU::ABS, &CPU::JSR, 6}, {"AND", &CPU::INX, &CPU::AND, 6}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"BIT", &CPU::ZP0, &CPU::BIT, 3}, {"AND", &CPU::ZP0, &CPU::AND, 3}, {"ROL", &CPU::ZP0, &CPU::ROL, 5}, {"???", &CPU::IMP, &CPU::XXX, 5}, {"PLP", &CPU::IMP, &CPU::PLP, 4}, {"AND", &CPU::IMM, &CPU::AND, 2}, {"ROL", &CPU::IMP, &CPU::ROL, 2}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"BIT", &CPU::ABS, &CPU::BIT, 4}, {"AND", &CPU::ABS, &CPU::AND, 4}, {"ROL", &CPU::ABS, &CPU::ROL, 6}, {"???", &CPU::IMP, &CPU::XXX, 6},
    {"BMI", &CPU::REL, &CPU::BMI, 2}, {"AND", &CPU::INY, &CPU::AND, 5}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"AND", &CPU::ZPX, &CPU::AND, 4}, {"ROL", &CPU::ZPX, &CPU::ROL, 6}, {"???", &CPU::IMP, &CPU::XXX, 6}, {"SEC", &CPU::IMP, &CPU::SEC, 2}, {"AND", &CPU::ABY, &CPU::AND, 4}, {"???", &CPU::IMP, &CPU::NOP, 2}, {"???", &CPU::IMP, &CPU::XXX, 7}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"AND", &CPU::ABX, &CPU::AND, 4}, {"ROL", &CPU::ABX, &CPU::ROL, 7}, {"???", &CPU::IMP, &CPU::XXX, 7},
    {"RTI", &CPU::IMP, &CPU::RTI, 6}, {"EOR", &CPU::INX, &CPU::EOR, 6}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"???", &CPU::IMP, &CPU::NOP, 3}, {"EOR", &CPU::ZP0, &CPU::EOR, 3}, {"LSR", &CPU::ZP0, &CPU::LSR, 5}, {"???", &CPU::IMP, &CPU::XXX, 5}, {"PHA", &CPU::IMP, &CPU::PHA, 3}, {"EOR", &CPU::IMM, &CPU::EOR, 2}, {"LSR", &CPU::IMP, &CPU::LSR, 2}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"JMP", &CPU::ABS, &CPU::JMP, 3}, {"EOR", &CPU::ABS, &CPU::EOR, 4}, {"LSR", &CPU::ABS, &CPU::LSR, 6}, {"???", &CPU::IMP, &CPU::XXX, 6},
    {"BVC", &CPU::REL, &CPU::BVC, 2}, {"EOR", &CPU::INY, &CPU::EOR, 5}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"EOR", &CPU::ZPX, &CPU::EOR, 4}, {"LSR", &CPU::ZPX, &CPU::LSR, 6}, {"???", &CPU::IMP, &CPU::XXX, 6}, {"CLI", &CPU::IMP, &CPU::CLI, 2}, {"EOR", &CPU::ABY, &CPU::EOR, 4}, {"???", &CPU::IMP, &CPU::NOP, 2}, {"???", &CPU::IMP, &CPU::XXX, 7}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"EOR", &CPU::ABX, &CPU::EOR, 4}, {"LSR", &CPU::ABX, &CPU::LSR, 7}, {"???", &CPU::IMP, &CPU::XXX, 7},
    {"RTS", &CPU::IMP, &CPU::RTS, 6}, {"ADC", &CPU::INX, &CPU::ADC, 6}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"???", &CPU::IMP, &CPU::NOP, 3}, {"ADC", &CPU::ZP0, &CPU::ADC, 3}, {"ROR", &CPU::ZP0, &CPU::ROR, 5}, {"???", &CPU::IMP, &CPU::XXX, 5}, {"PLA", &CPU::IMP, &CPU::PLA, 4}, {"ADC", &CPU::IMM, &CPU::ADC, 2}, {"ROR", &CPU::IMP, &CPU::ROR, 2}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"JMP", &CPU::IND, &CPU::JMP, 5}, {"ADC", &CPU::ABS, &CPU::ADC, 4}, {"ROR", &CPU::ABS, &CPU::ROR, 6}, {"???", &CPU::IMP, &CPU::XXX, 6},
    {"BVS", &CPU::REL, &CPU::BVS, 2}, {"ADC", &CPU::INY, &CPU::ADC, 5}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"ADC", &CPU::ZPX, &CPU::ADC, 4}, {"ROR", &CPU::ZPX, &CPU::ROR, 6}, {"???", &CPU::IMP, &CPU::XXX, 6}, {"SEI", &CPU::IMP, &CPU::SEI, 2}, {"ADC", &CPU::ABY, &CPU::ADC, 4}, {"???", &CPU::IMP, &CPU::NOP, 2}, {"???", &CPU::IMP, &CPU::XXX, 7}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"ADC", &CPU::ABX, &CPU::ADC, 4}, {"ROR", &CPU::ABX, &CPU::ROR, 7}, {"???", &CPU::IMP, &CPU::XXX, 7},
    {"???", &CPU::IMP, &CPU::NOP, 2}, {"STA", &CPU::INX, &CPU::STA, 6}, {"???", &CPU::IMP, &CPU::NOP, 2}, {"???", &CPU::IMP, &CPU::XXX, 6}, {"STY", &CPU::ZP0, &CPU::STY, 3}, {"STA", &CPU::ZP0, &CPU::STA, 3}, {"STX", &CPU::ZP0, &CPU::STX, 3}, {"???", &CPU::IMP, &CPU::XXX, 3}, {"DEY", &CPU::IMP, &CPU::DEY, 2}, {"???", &CPU::IMP, &CPU::NOP, 2}, {"TXA", &CPU::IMP, &CPU::TXA, 2}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"STY", &CPU::ABS, &CPU::STY, 4}, {"STA", &CPU::ABS, &CPU::STA, 4}, {"STX", &CPU::ABS, &CPU::STX, 4}, {"???", &CPU::IMP, &CPU::XXX, 4},
    {"BCC", &CPU::REL, &CPU::BCC, 2}, {"STA", &CPU::INY, &CPU::STA, 6}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 6}, {"STY", &CPU::ZPX, &CPU::STY, 4}, {"STA", &CPU::ZPX, &CPU::STA, 4}, {"STX", &CPU::ZPY, &CPU::STX, 4}, {"???", &CPU::IMP, &CPU::XXX, 4}, {"TYA", &CPU::IMP, &CPU::TYA, 2}, {"STA", &CPU::ABY, &CPU::STA, 5}, {"TXS", &CPU::IMP, &CPU::TXS, 2}, {"???", &CPU::IMP, &CPU::XXX, 5}, {"???", &CPU::IMP, &CPU::NOP, 5}, {"STA", &CPU::ABX, &CPU::STA, 5}, {"???", &CPU::IMP, &CPU::XXX, 5}, {"???", &CPU::IMP, &CPU::XXX, 5},
    {"LDY", &CPU::IMM, &CPU::LDY, 2}, {"LDA", &CPU::INX, &CPU::LDA, 6}, {"LDX", &CPU::IMM, &CPU::LDX, 2}, {"???", &CPU::IMP, &CPU::XXX, 6}, {"LDY", &CPU::ZP0, &CPU::LDY, 3}, {"LDA", &CPU::ZP0, &CPU::LDA, 3}, {"LDX", &CPU::ZP0, &CPU::LDX, 3}, {"???", &CPU::IMP, &CPU::XXX, 3}, {"TAY", &CPU::IMP, &CPU::TAY, 2}, {"LDA", &CPU::IMM, &CPU::LDA, 2}, {"TAX", &CPU::IMP, &CPU::TAX, 2}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"LDY", &CPU::ABS, &CPU::LDY, 4}, {"LDA", &CPU::ABS, &CPU::LDA, 4}, {"LDX", &CPU::ABS, &CPU::LDX, 4}, {"???", &CPU::IMP, &CPU::XXX, 4},
    {"BCS", &CPU::REL, &CPU::BCS, 2}, {"LDA", &CPU::INY, &CPU::LDA, 5}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 5}, {"LDY", &CPU::ZPX, &CPU::LDY, 4}, {"LDA", &CPU::ZPX, &CPU::LDA, 4}, {"LDX", &CPU::ZPY, &CPU::LDX, 4}, {"???", &CPU::IMP, &CPU::XXX, 4}, {"CLV", &CPU::IMP, &CPU::CLV, 2}, {"LDA", &CPU::ABY, &CPU::LDA, 4}, {"TSX", &CPU::IMP, &CPU::TSX, 2}, {"???", &CPU::IMP, &CPU::XXX, 4}, {"LDY", &CPU::ABX, &CPU::LDY, 4}, {"LDA", &CPU::ABX, &CPU::LDA, 4}, {"LDX", &CPU::ABY, &CPU::LDX, 4}, {"???", &CPU::IMP, &CPU::XXX, 4},
    {"CPY", &CPU::IMM, &CPU::CPY, 2}, {"CMP", &CPU::INX, &CPU::CMP, 6}, {"???", &CPU::IMP, &CPU::NOP, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"CPY", &CPU::ZP0, &CPU::CPY, 3}, {"CMP", &CPU::ZP0, &CPU::CMP, 3}, {"DEC", &CPU::ZP0, &CPU::DEC, 5}, {"???", &CPU::IMP, &CPU::XXX, 5}, {"INY", &CPU::IMP, &CPU::INY, 2}, {"CMP", &CPU::IMM, &CPU::CMP, 2}, {"DEX", &CPU::IMP, &CPU::DEX, 2}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"CPY", &CPU::ABS, &CPU::CPY, 4}, {"CMP", &CPU::ABS, &CPU::CMP, 4}, {"DEC", &CPU::ABS, &CPU::DEC, 6}, {"???", &CPU::IMP, &CPU::XXX, 6},
    {"BNE", &CPU::REL, &CPU::BNE, 2}, {"CMP", &CPU::INY, &CPU::CMP, 5}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"CMP", &CPU::ZPX, &CPU::CMP, 4}, {"DEC", &CPU::ZPX, &CPU::DEC, 6}, {"???", &CPU::IMP, &CPU::XXX, 6}, {"CLD", &CPU::IMP, &CPU::CLD, 2}, {"CMP", &CPU::ABY, &CPU::CMP, 4}, {"NOP", &CPU::IMP, &CPU::NOP, 2}, {"???", &CPU::IMP, &CPU::XXX, 7}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"CMP", &CPU::ABX, &CPU::CMP, 4}, {"DEC", &CPU::ABX, &CPU::DEC, 7}, {"???", &CPU::IMP, &CPU::XXX, 7},
    {"CPX", &CPU::IMM, &CPU::CPX, 2}, {"SBC", &CPU::INX, &CPU::SBC, 6}, {"???", &CPU::IMP, &CPU::NOP, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"CPX", &CPU::ZP0, &CPU::CPX, 3}, {"SBC", &CPU::ZP0, &CPU::SBC, 3}, {"INC", &CPU::ZP0, &CPU::INC, 5}, {"???", &CPU::IMP, &CPU::XXX, 5}, {"INX", &CPU::IMP, &CPU::INX, 2}, {"SBC", &CPU::IMM, &CPU::SBC, 2}, {"NOP", &CPU::IMP, &CPU::NOP, 2}, {"???", &CPU::IMP, &CPU::SBC, 2}, {"CPX", &CPU::ABS, &CPU::CPX, 4}, {"SBC", &CPU::ABS, &CPU::SBC, 4}, {"INC", &CPU::ABS, &CPU::INC, 6}, {"???", &CPU::IMP, &CPU::XXX, 6},
    {"BEQ", &CPU::REL, &CPU::BEQ, 2}, {"SBC", &CPU::INY, &CPU::SBC, 5}, {"???", &CPU::IMP, &CPU::XXX, 2}, {"???", &CPU::IMP, &CPU::XXX, 8}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"SBC", &CPU::ZPX, &CPU::SBC, 4}, {"INC", &CPU::ZPX, &CPU::INC, 6}, {"???", &CPU::IMP, &CPU::XXX, 6}, {"SED", &CPU::IMP, &CPU::SED, 2}, {"SBC", &CPU::ABY, &CPU::SBC, 4}, {"NOP", &CPU::IMP, &CPU::NOP, 2}, {"???", &CPU::IMP, &CPU::XXX, 7}, {"???", &CPU::IMP, &CPU::NOP, 4}, {"SBC", &CPU::ABX, &CPU::SBC, 4}, {"INC", &CPU::ABX, &CPU::INC, 7}, {"???", &CPU::IMP, &CPU::XXX, 7},
};
